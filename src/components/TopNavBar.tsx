    ...
    return (<>
        <form className="flex items-center">
            ...
            <div className="relative w-full">
                ...
                <input type="text" id="device-ip" value={ipAddress} onChange={(e) => setIpAddress(e.target.value)}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Device IP address..." required />
                <button type="button" className="absolute inset-y-0 right-0 flex items-center pr-3" onClick={onConnect}>
                    ...
                    <svg aria-hidden="true" className="w-5 h-5 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9.348 14.651a3.75 3.75 0 010-5.303m5.304 0a3.75 3.75 0 010 5.303m-7.425 2.122a6.75 6.75 0 010-9.546m9.546 0a6.75 6.75 0 010 9.546M5.106 18.894c-3.808-3.808-3.808-9.98 0-13.789m13.788 0c3.808 3.808 3.808 9.981 0 13.79M12 12h.008v.007H12V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </button>
            </div>
        ...
        >
            ...
            <Navbar.Collapse>
                ...
                {/* <TextInput
                    ...
                    sizing="sm"
                    type="string"
                    color={AppState.initState ? isConnected ? "success" : "failure" : "warning"}
                    value={ipAddress}
                    onChange={(e) => setIpAddress(e.target.value)}
                />
                <ToggleSwitch checked={isConnected} onChange={onConnect} label={""} /> */}
                {/* <div className="relative w-full">
